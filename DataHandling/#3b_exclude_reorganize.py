...
inclusion_filepath = r"C:\Users\foivo\Documents\Satori\SampleData\MULPA Dataset\1_Data_Actual_Reorganized_TrimmedToEvents\Quality Assessment BioSignalBy JOAO PEREIRA.xlsx"
inclusion_df = pd.read_excel(inclusion_filepath, sheet_name="FinalDatasheet")
...
# Delete from the folder the subfolders that are not needed: like restingstate_trimmedtoevents, motor_action_trimmedtoevents, restingstate_od_SCI_texts
# keep only the subfolders that you need for further processing
