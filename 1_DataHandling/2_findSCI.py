...
for file in os.listdir(input_folder):
    if file.endswith('.txt'):
        ...
        clean_name = file[:pos_clean_name-1]
...
# Count participants with >25% exclusion for long channels
...
# Count participants with >25% exclusion for short channels  
...
# Count participants with >25% exclusion for BOTH long AND short channels
